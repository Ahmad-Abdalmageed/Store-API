...
var index = (0, Wrappers_1.tryCatchWrapExpress)(function(req, res, next) {
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, products.listAll()];
        case 1:
          results = _a.sent();
          if (!results)
            return [2 /*return*/, next(new apiError_1.apiError(404, 'No Products Found'))];
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        ...
        case 1:
          foundProd = _a.sent();
          if (!foundProd)
            return [2 /*return*/, next(new apiError_1.apiError(404, 'Product with ID: '.concat(pid, ' is not Found')))];
