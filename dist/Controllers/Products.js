...
var products = new Product_1.ProductTable();
// List All Products
var index = (0, Wrappers_1.tryCatchWrapExpress)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, products.listAll()];
            case 1:
                results = _a.sent();
                if (!results || results.length == 0)
                    return [2 /*return*/, next(new apiError_1.apiError(204, 'No Products Found'))];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, products.create(newProd)];
            case 1:
                results = _a.sent();
                res.status(200).send(results);
                return [2 /*return*/];
...
var erase = (0, Wrappers_1.tryCatchWrapExpress)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var pid, foundProd, results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pid = Number(req.params.pid);
                return [4 /*yield*/, products.getProduct(pid)];
            case 1:
                foundProd = _a.sent();
                if (!foundProd)
                    return [2 /*return*/, next(new apiError_1.apiError(204, "Product with ID: ".concat(pid, " is not Found")))];
                return [4 /*yield*/, products.delete(pid)];
            case 2:
                results = _a.sent();
                res.status(200).send(results);
                return [2 /*return*/];
