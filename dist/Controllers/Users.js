...
var index = (0, Wrappers_1.tryCatchWrapExpress)(function(req, res, next) {
    return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, users.listAll()];
                case 1:
                    results = _a.sent();
                    if (!results || results.length == 0)
                        return [
                            2 /*return*/,
                            next(new apiError_1.apiError(404, 'No Users Found'))
                        ];
...
var search = (0, Wrappers_1.tryCatchWrapExpress)(function(req, res, next) {
    return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, users.getUser(Number(req.params.uid))];
                case 1:
                    results = _a.sent();
                    ...
                    if (!results)
                        return [
                            2 /*return*/,
                            next(new apiError_1.apiError(404, 'User could not be found'))
                        ];
                    res.status(200).json(results);
                    return [2 /*return*/];
            }
                        ...
                        return [
                            ...
                            next(
                              new apiError_1.apiError(
                                404,
                                'User with ID: '.concat(uid, ' is not Found')
                              )
                            )
                        ];
