...
eb setenv RDS_HOSTNAME="$RDS_HOSTNAME" RDS_PORT="$RDS_PORT" RDS_DB_NAME="$RDS_DB_NAME" RDS_DB_NAME_TEST="$RDS_DB_NAME_TEST" RDS_USERNAME="$RDS_USERNAME" RDS_PASSWORD="$RDS_PASSWORD" ENV="$ENV" BCRYPT_PASSWORD="$BCRYPT_PASSWORD" SALT_ROUNDS="$SALT_ROUNDS" TOKEN_SECRET=$TOKEN_SECRET
