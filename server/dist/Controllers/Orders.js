        ...
        switch (_b.label) {
            case 0:
                if (((_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(' ')[1]) !== 'Admin')
                    return [2 /*return*/, next(new apiError_1.apiError(401, 'Bad Authentication'))];
                return [4 /*yield*/, orders.listAll()];
            case 1:
                results = _b.sent();
                if (!results || results.length == 0)
                    return [2 /*return*/, next(new apiError_1.apiError(204, 'No Orders Found'))];
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (foundID.uid !== res.locals.uid)
                    return [2 /*return*/, next(new apiError_1.apiError(401, 'Bad Authentication'))];
                if (!foundID)
                    return [2 /*return*/, next(new apiError_1.apiError(204, "Order with ID: ".concat(oid, " is not found")))];
...
var getUserOrders = (0, Wrappers_1.tryCatchWrapExpress)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var uid, foundOrders;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
